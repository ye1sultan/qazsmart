    ...
    <div className="min-h-screen flex flex-col">
      ...
      <div className="container mx-auto flex flex-col justify-start items-start py-8 flex-grow gap-y-12 sm:gap-y-14">
        ...
        <form
          ...
          className="w-full max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col justify-center items-start flex-wrap gap-y-5"
        >
              ...
              {[1, 2, 3, 4, 5].map((star) => (
                <svg
                  ...
                  className={`h-6 w-6 flex-shrink-0 cursor-pointer ${
                    star <= formData.stars ? "fill-yellow-400" : "fill-gray-300"
                  }`}
