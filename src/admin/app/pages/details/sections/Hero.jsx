    ...
    <>
      <div className="w-full flex flex-col justify-center items-start">
        <div className="w-full">
          <div className="text-lg font-medium">Главная секция</div>
            ...
            <div className="w-full flex flex-row justify-start items-end gap-x-6 gap-y-2">
              <div>
                ...
                <input
                  ...
                  name="btnText"
                  id="btnText"
                  className="mt-1 max-w-xs w-full rounded-md border-0 py-1.5 px-4 text-neutral-900 ring-1 ring-inset ring-neutral-300 placeholder:text-neutral-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
