                ...
                <div className="w-full">
                    ...
                    <div className="w-full flex flex-col gap-y-2">
                        <div className="max-w-lg w-full mt-2 flex flex-col md:flex-row justify-center items-center gap-2">
                            <div className="w-full">
                                <label htmlFor="textCopy" className="block text-sm font-medium text-gray-700">
                        ...
                        <div className="w-full">
                            ...
                            <div className="mt-1 max-w-lg w-full flex justify-between items-center">
                                <div className="w-full flex justify-start items-center gap-x-2">
                                    {navigation.map((item) => (
                                        <div key={item.name} className="text-gray-900 hover:text-gray-600 cursor-pointer">
                        ...
                        <div className="max-w-lg w-full flex flex-col justify-start items-start">
                            ...
                            <input
                                ...
                                id="imageInput"
                            />
                            <img className="mt-1 rounded-md" src={footerData.imageUrl} alt="" />
                        </div>
