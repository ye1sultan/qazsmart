...
export default function Footer() {
  ...
  const [footerData, setFooterData] = useState({
    textCopy: "© 2023 QazSmart, Inc. All rights reserved.",
  ...
  const handleButtonClick = () => {
    if (footerData.textCopy && footerData.imageUrl) {
    ...
    <>
      <div className="w-full flex flex-col justify-center items-start">
        <div className="w-full">
          <div className="text-lg font-medium">Нижняя секция</div>
          <div className="w-full flex flex-col gap-y-2">
            ...
            <div className="w-full">
              ...
              <div className="mt-1 max-w-lg w-full flex justify-between items-center">
                <div className="w-full flex justify-start items-center gap-x-2">
                  {navigation.map((item) => (
                    <div
                      key={item.name}
                      className="text-neutral-900 hover:text-neutral-600 cursor-pointer"
                    >
                ...
                <button className="mt-1 rounded-md px-2 py-2 text-xs  font-semibold text-white shadow-sm bg-sky-600 hover:bg-sky-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-sky-500 cursor-pointer">
                  Добавить
                </button>
              </div>
            </div>
