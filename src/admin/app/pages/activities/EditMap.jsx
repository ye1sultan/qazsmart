...
const Tooltip = ({ setSelectedLocation, setMarker, setFormData }) => {
  ...
  return (
    <div className="bg-white rounded-md shadow-xl p-2">
      <div className="text-xl font-medium">Удалить маркер?</div>
  ...
  return (
    <div className="w-full">
      <div className="w-full flex flex-col justify-between items-start mb-4">
        <div className="block text-base font-medium text-neutral-700 mb-2">
          Координаты на карте
        </div>
      ...
      >
        ...
        {marker && <MarkerF onClick={handleMarkerClick} position={coord} />}
      </GoogleMap>
    </div>
  );
};
