...
export default function EditActivity() {
    ...
    const defaultDescription = { name: { en: "", ru: "" }, description: { en: "", ru: "" } };
    ...
    const [formData, setFormData] = useState({
        ...
        descriptions: passedProps.descriptions ? passedProps.descriptions.map((desc) => ({
            name: {
                en: desc.name.en || "",
                ru: desc.name.ru || "",
            },
    ...
    const handleEditClick = async () => {
        ...
        if (!hasEmptyField && !hasEmptyDescriptions && imageUrl) {
            try {
                ...
                const { data } = await axios.patch(`/activities/${passedProps._id}`, formData);
                console.log(data);
