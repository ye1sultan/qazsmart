  ...
  return (
    <>
      <Alert
        ...
        text={"Удалить отзыв?"}
        subText={
          "Вы уверены что хотите удалить отзыв? Действие нельзя будет отменить."
        }
        btnText={"Удалить"}
        deleteClicked={deleteReview}
      />
      <div className="flex text-sm text-neutral-500 space-x-4 max-w-[900px] px-10 rounded-xl border border-neutral-200 shadow-lg relative">
        <button
        ...
        <div className="py-5">
          <h3 className="text-lg font-medium text-neutral-900">{data.name}</h3>
            ...
            {[0, 1, 2, 3, 4].map((rating) => (
              <svg
                ...
                className={classNames(
                  data.stars > rating ? "text-yellow-400" : "text-neutral-300",
          ...
          <div
            className="mt-4 prose prose-base max-w-none text-neutral-600"
